 ...
 */
	var element = {},
		...
		vars = [
					...
					'lang_voices', 'irate','options_title', 'logo', 'app_logo', 'collect'
				];
/*
 * ---------------------------------------------------------------------------------------------------------------------
...
function init_listeners()
{
	...
	element.collect.addEventListener('change', function()
	{
		save_options();
	});
...
function save_options()
{
  	...
  	var options =
	{
		...
		collect : element.collect.checked,
...
function restore_options()
{
	...
	element.collect.checked = options.collect;
}
