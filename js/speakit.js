...
*/
	(function(){
		if(options == null || options.version === undefined || options.version != getVersion()) // notify users for version update
		{
			...
			if(vupdate == 'installed')
			{
				chrome.tabs.create // open options page after instalation
				(
					{
						url: chrome.extension.getURL('options.html?'+vupdate)
					}
				);
			}
		}
...
*/
	...
	{
		state = 'paused';
		if(options.voice == 'SpeakIt!' || options.voice == 'iSpeech')
		{
